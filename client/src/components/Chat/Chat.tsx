  ...
  return (
    <div className={`chat-content ${isSourcesSidebarOpen ? 'sidebar-open' : ''}`}>
      <div className="chat-header">
        <Header 
          icon={
            <svg className="chat-logo" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <form onSubmit={handleSubmit} className="input-area">
        <div className="input-container">
          ...
          <button className="submit-button" type="submit" disabled={isThinking}>
