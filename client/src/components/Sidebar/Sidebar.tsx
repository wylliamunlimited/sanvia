  ...
  const menuItems = [
    {
      ...
      label: 'Profile',
      icon: (
        <svg className="menu-item-image" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
