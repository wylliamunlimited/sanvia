  ...
  return (
    <div className="documents-content">
      <div className="documents-header">
        <Header 
          icon={
            <svg className="documents-logo" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="documents-area">
        <p  className="uploade-text">Sanvia can use your documents to create a more personalized experience for you.</p>
        <div 
        ...
        >
          {isUploading ? (
            ...
            <>
              <svg className="upload-symbol" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/>
                <polyline points="17 8 12 3 7 8"/>
                <line x1="12" y1="3" x2="12" y2="15"/>
              </svg>
              <p className="text-replace">Drag and drop files here or</p>
